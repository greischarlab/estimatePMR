...
SEXP archer_fitN_odeint(NumericVector parms,
  ...
  double step_size = 30;
  arma::mat subsetMatrix = subsetRows(odeint_output, step_size);
  ...
  arma::vec circ_iRBC_rep = repeat_subvector(circ_iRBC_unique);
  ...
  arma::vec ring_prop_rep = repeat_subvector(ring_prop_estim);
